...
If you find a security vulnerability in go2web, please report it through [GitHub's private vulnerability reporting](https://github.com/m33ga/go2web/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact mihai.gurduza@isa.utm.md for details.
